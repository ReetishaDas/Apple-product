import 'productDetails/ipad.dart';
import 'productDetails/iphone.dart';
import 'productDetails/mac.dart';
...
class _CustomVideoProgressIndicatorState
        ...
        children: <Widget>[
          ...
          Row(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  navigateProduct(Product.iphone);
                },
                child: Text(
                  "iphone",
                  style: TextStyle(color: Colors.transparent, fontSize: 8),
                ),
              ),
              SizedBox(
                width: 70,
  ...
  void navigateProduct(Product product) {
    if (product == Product.iphone) {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => IPhone()));
    } else if (product == Product.mac) {
      Navigator.push(context, MaterialPageRoute(builder: (context) => Mac()));
    } else if (product == Product.ipad) {
      Navigator.push(context, MaterialPageRoute(builder: (context) => IPad()));
    }
  }
}
